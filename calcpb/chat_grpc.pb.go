...
type ServicesClient interface {
	ChatService(ctx context.Context, in *AdditionRequestFromUser, opts ...grpc.CallOption) (Services_ChatServiceClient, error)
}
...
func (c *servicesClient) ChatService(ctx context.Context, in *AdditionRequestFromUser, opts ...grpc.CallOption) (Services_ChatServiceClient, error) {
	stream, err := c.cc.NewStream(ctx, &Services_ServiceDesc.Streams[0], "/calcpb.Services/ChatService", opts...)
	if err != nil {
		return nil, err
	}
...
type Services_ChatServiceClient interface {
	Recv() (*AdditionResponseFromServer, error)
	grpc.ClientStream
}
...
func (x *servicesChatServiceClient) Recv() (*AdditionResponseFromServer, error) {
	m := new(AdditionResponseFromServer)
...
type ServicesServer interface {
	ChatService(*AdditionRequestFromUser, Services_ChatServiceServer) error
...
func (UnimplementedServicesServer) ChatService(*AdditionRequestFromUser, Services_ChatServiceServer) error {
...
type Services_ChatServiceServer interface {
	Send(*AdditionResponseFromServer) error
	grpc.ServerStream
}
...
func (x *servicesChatServiceServer) Send(m *AdditionResponseFromServer) error {
